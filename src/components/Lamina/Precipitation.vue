        ...
        <div class="card-content precipitation-card">
          <span class="card-title">Dados sobre Precipitação</span>
            <div class="input-field">
              ...
              <span class="error-message" v-if="$v.dailyPrecipitation.$invalid">Caso não houve precipitação neste dia, digite 0 no campo. (OBSERVAÇÃO.: O separador decimal é ponto(.) e não vírgula (,)!</span>
            </div>
          </div>
