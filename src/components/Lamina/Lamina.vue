                ...
                <div class="row efficiency-table" v-else>
                  <table class="bordered responsive-table centered">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <input type="radio" id="value1" v-model="systemEfficiency" :value="60.0001"/>
                      ...
                      <tr>
                        <td>
                          <input type="radio" id="value4" v-model="systemEfficiency" :value="95.0001"/>
                      ...
                      <tr>
                        <td>
                          <input type="radio" id="value5" v-model="systemEfficiency" :value="60.0002"/>
                      ...
                      <tr>
                        <td>
                          <input type="radio" id="value6" v-model="systemEfficiency" :value="80.0001"/>
                      ...
                      <tr>
                        <td>
                          <input type="radio" id="value7" v-model="systemEfficiency" :value="85.0001"/>
                      ...
                      <tr>
                        <td>
                          <input type="radio" id="value10" v-model="systemEfficiency" :value="90.0001"/>
